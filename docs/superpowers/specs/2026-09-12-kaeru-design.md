...
- UX: действие «Скачать» на серии в сетке тайтла и в плеере, выбор качества загрузки в настройках, раздел «Загрузки» (список, размер, удаление, лимит места), пометка скачанных серий в сетке и на карточках, автоматическое удаление после просмотра по желанию; на главной в офлайне показываются только скачанные тайтлы и «Продолжить» работает без сети; прогресс и отметки просмотра копятся локально и синхронизируются с Shikimori при появлении сети.
