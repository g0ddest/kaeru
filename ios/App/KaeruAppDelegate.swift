...
// The iPhone and iPad side of the application: UIKit's delegate and BGTaskScheduler. The Mac app
// is generated without this file (see generate_project.rb) and brings its own.
