 ...
 * what makes them arrive as one. Everything else about it is the same as the two repositories
 * whose rows it writes — the account lock once, and SQLite's failures translated on the way out.
 */
@Singleton
