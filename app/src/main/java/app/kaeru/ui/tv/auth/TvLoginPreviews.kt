...
/** The old way through, mid-typing, with a code Shikimori would not take. */
@Preview(showBackground = true, backgroundColor = DARK, device = Devices.TV_1080p)
@Composable
private fun TvLoginTypedCodePreview() = Preview(
    pairing = offer(),
    state = AuthUiState(loggedIn = false, errorMessage = "Не удалось подтвердить вход. Войдите заново"),
    code = "aBc1dEf2gHi3",
)
